...
<head>
	<meta charset='utf-8'/>
	<title>Source: polyfills-es5.min.js - Just js</title>
...
<body data-gs='{"openPageHeader": "is-page-header-open", "searching": "is-searching"}'>
	<div id='page-wrapper'>
		...
		<div id='main-wrapper'>
			...
			<main id='content'>
				<header>
					<h1 id='content-title'>Source: polyfills-es5.min.js</h1>
				</header>
